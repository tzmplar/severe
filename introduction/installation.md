...
We utilize **HWID** to provide a secure connection from your machine to our servers, changing a part in your PC can sometimes cause this to change. In this case, please navigate to our [Keyauth Page](https://keyauth.cc/panel/SHELUV_PERKS/v-severe) and press **"Reset HWID"**.
